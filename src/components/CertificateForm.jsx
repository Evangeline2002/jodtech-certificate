...
import SignatureUpload from './sidebar/SignatureUpload';
    ...
    <div className={`flex ${fullScreen ? 'fixed inset-0 z-[100]' : ''} bg-slate-100`} style={{ height: fullScreen ? '100vh' : '100vh' }}>
      ...
      <div className={`no-print flex flex-col bg-white border-r border-gray-200 shadow-lg ${fullScreen ? 'hidden' : ''}`}
        ...
        <div className="flex-1 overflow-y-auto px-4 py-4 space-y-4">
          ...
          <SidebarCard icon={Save} title="Digital Signatures">
            <div className="space-y-3">
              <SignatureUpload label="HR Signature" type="hrSignature" />
              <SignatureUpload label="Director Signature" type="directorSignature" />
              <SignatureUpload label="Company Seal" type="companySeal" />
            </div>
          </SidebarCard>
